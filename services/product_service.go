...
type IProductService interface {
	...
	InsertLogProduct(log datamodels.Log)error
}
...
func (p *ProductService) InsertLogProduct(log datamodels.Log)(err error) {
	return p.productRepository.InsertLoggerProduct(log)
}
